package com.softtech.maplocationpicker;
...
import com.softtech.maplocationpicker.R;
...
public class LocationPickerActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private CardView imgSearchLayout;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        FloatingActionButton imgCurrentloc = findViewById(R.id.imgCurrentloc);
        ...
        ImageView imgBackPress = findViewById(R.id.imgBackPress);

        imgSearch = findViewById(R.id.imgSearch);
        imgSearchLayout = findViewById(R.id.imgSearchLayout);
        ...
        imgSearchLayout.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void addMarker() {
        ...
        if (mMap != null) {
            ...
            try {
                mMap.clear();
                imgSearch.setText("" + userAddress);
                markerOptions = new MarkerOptions().position(coordinate).title(userAddress).icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_map_pin));
                if(isZooming) {
